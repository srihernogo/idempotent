 ...
 *
 * @param maxAttempts       Maximum number of retry attempts for in-progress
 *                          requests.
 * @param delay             Delay before a retry: initialInterval +
 *                          (backoffMultiplier ^ attemptNumber).
 * @param backoffMultiplier Multiplier used for exponential backoff between
 *                          retries.
 */
