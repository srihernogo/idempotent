...
/**
 * Default Jackson settings for idempotent value serialization (polymorphic
 * return types).
 */
public final class IdempotentJsonMapperDefaults {
    ...
    /**
     * Applies permissive default typing so arbitrary response types round-trip.
     * Covers Java records,
     * Kotlin data classes, and all other final types. Suitable only when store
    ...
    /**
     * Type resolver that writes {@code @class} for all types, including final
     * classes like
